...
-- Design Ports Information
-- mayor	=>  Location: PIN_A9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- menor	=>  Location: PIN_A10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- igual	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\mayor~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
\menor~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\igual~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\menor~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \menor~0_combout\ = (\A[1]~input_o\ & (!\A[0]~input_o\ & (\B[0]~input_o\ & \B[1]~input_o\))) # (!\A[1]~input_o\ & ((\B[1]~input_o\) # ((!\A[0]~input_o\ & \B[0]~input_o\))))
...
\igual~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \igual~0_combout\ = (\A[1]~input_o\ & ((\A[0]~input_o\ $ (\B[0]~input_o\)) # (!\B[1]~input_o\))) # (!\A[1]~input_o\ & ((\B[1]~input_o\) # (\A[0]~input_o\ $ (\B[0]~input_o\))))
